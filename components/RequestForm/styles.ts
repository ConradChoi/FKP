// Design Ref: §7 Design Tokens — input/button 공통 스타일
export const inputClass =
  'rounded-input border border-neutral-300 bg-neutral-0 px-4 py-2.5 text-body text-neutral-900 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500'
